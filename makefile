...
puzzle: main.o bundle.o text_utils.o number_utils.o system_utils.o vector_utils.o input.o input_validator.o input_converter.o action.o input_action.o position.o figure.o grid.o drawing_generator.o puzzle.o puzzle_generator.o main_menu_controller.o screen.o puzzles_file_manager.o
	g++ main.o bundle.o text_utils.o number_utils.o system_utils.o vector_utils.o input.o input_validator.o input_converter.o action.o input_action.o position.o figure.o grid.o drawing_generator.o puzzle.o puzzle_generator.o main_menu_controller.o screen.o puzzles_file_manager.o -o puzzle -std=c++11
